...
RcppExport SEXP Rtsne_Rtsne_cpp(SEXP ISEXP, SEXP JSEXP, SEXP VSEXP, SEXP no_dims_inSEXP, SEXP perplexity_inSEXP, SEXP theta_inSEXP, SEXP verboseSEXP, SEXP max_iterSEXP, SEXP distance_precomputedSEXP, SEXP Y_inSEXP, SEXP initSEXP) {
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(Rtsne_cpp(I, J ,V , no_dims_in, perplexity_in, theta_in, verbose, max_iter, distance_precomputed, Y_in, init));
    return __result;
END_RCPP
}
