...
\affil[2]{Dipartimento di Informatica Sistemistica e Comunicazione, Università degli Studi Milano Bicocca Milano, Italy.}
...
\item[1.7.3] removed the CIMLR clustering method; for it, please refer to https://github.com/danro9685/CIMLR. 
\end{itemize}
